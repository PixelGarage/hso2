...
$segment = !empty($course->field_segment) ? taxonomy_term_load($course->field_segment[LANGUAGE_NONE][0]['tid']) : 0;
$start_date = $course_times->field_course_date[LANGUAGE_NONE][0]['value'];
$start_timestamp = strtotime($start_date);
$output = (($start_timestamp - $now) > 864000 && $segment != 160 && $segment != 164) ? l($output, 'node/' . $row->nid . '/reservation', array('html' => TRUE)) : '';
?>
<?php print $output; ?>
