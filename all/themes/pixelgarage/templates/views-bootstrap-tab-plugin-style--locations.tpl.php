          ...
          <div class="col-sm-8">
            ...
            <div class="map-location">
              <a href="https://maps.google.com/maps?q=<?php print $location['map_location']; ?>" target="_blank">
                <img src="https://maps.googleapis.com/maps/api/staticmap?center=<?php print $location['map_location']; ?>&language=de&size=238x188&maptype=roadmap&markers=color:red%7C<?php print $location['map_location']; ?>&sensor=false" alt="" />
              </a>
            </div>
            <div class="location-image"><?php print $location['picture']; ?></div>
          </div>
        </div>
      </div>
    <?php endforeach ?>
