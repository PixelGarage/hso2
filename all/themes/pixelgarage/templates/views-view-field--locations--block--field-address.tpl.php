...
<div class="phone-number"><span class="fa fa-phone"></span> <?php print check_plain($address['phone_number']); ?></div>
<div class="phone-number"><span class="fa fa-fax"></span> <?php print check_plain($address['fax_number']); ?></div>
